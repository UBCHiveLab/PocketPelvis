...
public class ModelBehaviour_04092018 : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        else if (ARObjectState == (int)hasActiveARObject.justFound)
        {
            ...
            */
            ...
            this.gameObject.transform.eulerAngles = Vector3.Lerp(oldRot, activeARObject.transform.eulerAngles, timeDifferenceRatio);
        }
    }
