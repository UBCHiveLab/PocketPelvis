...
/**
 * @brief Called whenever an operation could not be completed successfully.
 *
 * @param captureDeviceManager The capture device manager that could not complete its operation.
 * @param error The error object containing information about the failed operation.
 */
